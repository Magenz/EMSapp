        ...
        <div class="card col-md-3 bg-light m-1 p-3">
            ...
            <div>
                ...
                <h5>
                 ...
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Middle Name:</h4>
                    <h5>{{$family->spouse_middlename}}</h5>
                 </h5>
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Name Extention:</h4>
                    <h5>{{$family->spouse_name_ext}}</h5>
                 </h5>
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Occupation:</h4>
                    <h5>{{$family->spouse_occupation}}</h5>
                 </h5>
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Employer / Business:</h4>
                    <h5>{{$family->spouse_employer_business}}</h5>
                 </h5>
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Employment / Business Address:</h4>
                    <h5>{{$family->spouse_business_address}}</h5>
                 </h5>
                 <hr>
                 <h5>
                    <h4 class="text-secondary">Contact Number:</h4>
...
<div class="card col-md-3 bg-light m-1 p-3">
    ...
    <div>
        <h5>
            <h4 class="text-secondary">Maiden Name:</h4>
