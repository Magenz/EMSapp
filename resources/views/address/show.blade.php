...
<div class="card col-md-3 bg-light m-1 p-3">
    <h5 class="  "><p class="text-secondary">House Block</p></h5>           
...
<div class="card col-md-5 bg-light m-1 p-3">
    ...
    <div>
        <h5>{{$address->res_subvil}}</h5>
    </div>
</div>

<div class="card col-md-3 bg-light m-1 p-3">
    <h5 class="  "><p class="text-secondary">Barangay</p></h5>           
